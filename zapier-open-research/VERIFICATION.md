...
автоматическими poll пока нельзя утверждать. Личный адресат Email указан, но Email Zap
ещё не создан из-за недоступного браузерного канала. На момент проверки Task Usage
показывал 24 billable tasks за 30 дней:
