"""Локальная панель дня 14: накопительный агент, FSM и инварианты."""
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _chat(self, text: str) -> dict:
        ...
        model_called = (
            ...
            else reply.finish_reason not in {"local_state", "invariant_refusal", "invariant_explanation"} and not reply.overflow
        )
        state_error = None
        try:
        ...
        return {
            ...
            "saved": reply.saved,
            "decision": (
                "refuse" if reply.finish_reason in {"invariant_refusal", "invariant_output_blocked"}
